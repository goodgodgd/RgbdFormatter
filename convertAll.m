...
reformatData('scannet', sourcePath, targetPath, sceneDirPattern)
...
reformatData('tum', sourcePath, targetPath, sceneDirPattern)
...
reformatData('rgbd-scenes', sourcePath, targetPath, sceneDirPattern)
